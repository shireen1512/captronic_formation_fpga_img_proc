...
module soc_system_mm_interconnect_1 (
		...
		input  wire         read_ram_0_reset_reset_bridge_in_reset_reset,                       //                       read_ram_0_reset_reset_bridge_in_reset.reset
		input  wire [31:0]  read_ram_0_m0_address,                                              //                                                read_ram_0_m0.address
		output wire         read_ram_0_m0_waitrequest,                                          //                                                             .waitrequest
		input  wire         read_ram_0_m0_read,                                                 //                                                             .read
		output wire [255:0] read_ram_0_m0_readdata,                                             //                                                             .readdata
		output wire         read_ram_0_m0_readdatavalid,                                        //                                                             .readdatavalid
	...
	wire          read_ram_0_m0_translator_avalon_universal_master_0_waitrequest;   // read_ram_0_m0_agent:av_waitrequest -> read_ram_0_m0_translator:uav_waitrequest
	wire  [255:0] read_ram_0_m0_translator_avalon_universal_master_0_readdata;      // read_ram_0_m0_agent:av_readdata -> read_ram_0_m0_translator:uav_readdata
	wire          read_ram_0_m0_translator_avalon_universal_master_0_debugaccess;   // read_ram_0_m0_translator:uav_debugaccess -> read_ram_0_m0_agent:av_debugaccess
	wire   [31:0] read_ram_0_m0_translator_avalon_universal_master_0_address;       // read_ram_0_m0_translator:uav_address -> read_ram_0_m0_agent:av_address
	wire          read_ram_0_m0_translator_avalon_universal_master_0_read;          // read_ram_0_m0_translator:uav_read -> read_ram_0_m0_agent:av_read
	wire   [31:0] read_ram_0_m0_translator_avalon_universal_master_0_byteenable;    // read_ram_0_m0_translator:uav_byteenable -> read_ram_0_m0_agent:av_byteenable
	wire          read_ram_0_m0_translator_avalon_universal_master_0_readdatavalid; // read_ram_0_m0_agent:av_readdatavalid -> read_ram_0_m0_translator:uav_readdatavalid
	wire          read_ram_0_m0_translator_avalon_universal_master_0_lock;          // read_ram_0_m0_translator:uav_lock -> read_ram_0_m0_agent:av_lock
	wire          read_ram_0_m0_translator_avalon_universal_master_0_write;         // read_ram_0_m0_translator:uav_write -> read_ram_0_m0_agent:av_write
	wire  [255:0] read_ram_0_m0_translator_avalon_universal_master_0_writedata;     // read_ram_0_m0_translator:uav_writedata -> read_ram_0_m0_agent:av_writedata
	wire    [5:0] read_ram_0_m0_translator_avalon_universal_master_0_burstcount;    // read_ram_0_m0_translator:uav_burstcount -> read_ram_0_m0_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                // rsp_mux:src_valid -> read_ram_0_m0_agent:rp_valid
	wire  [363:0] rsp_mux_src_data;                                                 // rsp_mux:src_data -> read_ram_0_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                // read_ram_0_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                              // rsp_mux:src_channel -> read_ram_0_m0_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                        // rsp_mux:src_startofpacket -> read_ram_0_m0_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                          // rsp_mux:src_endofpacket -> read_ram_0_m0_agent:rp_endofpacket
	...
	wire          read_ram_0_m0_agent_cp_valid;                                     // read_ram_0_m0_agent:cp_valid -> router:sink_valid
	wire  [363:0] read_ram_0_m0_agent_cp_data;                                      // read_ram_0_m0_agent:cp_data -> router:sink_data
	wire          read_ram_0_m0_agent_cp_ready;                                     // router:sink_ready -> read_ram_0_m0_agent:cp_ready
	wire          read_ram_0_m0_agent_cp_startofpacket;                             // read_ram_0_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire          read_ram_0_m0_agent_cp_endofpacket;                               // read_ram_0_m0_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) read_ram_0_m0_translator (
		.clk                    (clk_0_clk_clk),                                                                                                                                                                                                                                                         //                       clk.clk
		.reset                  (read_ram_0_reset_reset_bridge_in_reset_reset),                                                                                                                                                                                                                          //                     reset.reset
		.uav_address            (read_ram_0_m0_translator_avalon_universal_master_0_address),                                                                                                                                                                                                            // avalon_universal_master_0.address
		.uav_burstcount         (read_ram_0_m0_translator_avalon_universal_master_0_burstcount),                                                                                                                                                                                                         //                          .burstcount
		.uav_read               (read_ram_0_m0_translator_avalon_universal_master_0_read),                                                                                                                                                                                                               //                          .read
		.uav_write              (read_ram_0_m0_translator_avalon_universal_master_0_write),                                                                                                                                                                                                              //                          .write
		.uav_waitrequest        (read_ram_0_m0_translator_avalon_universal_master_0_waitrequest),                                                                                                                                                                                                        //                          .waitrequest
		.uav_readdatavalid      (read_ram_0_m0_translator_avalon_universal_master_0_readdatavalid),                                                                                                                                                                                                      //                          .readdatavalid
		.uav_byteenable         (read_ram_0_m0_translator_avalon_universal_master_0_byteenable),                                                                                                                                                                                                         //                          .byteenable
		.uav_readdata           (read_ram_0_m0_translator_avalon_universal_master_0_readdata),                                                                                                                                                                                                           //                          .readdata
		.uav_writedata          (read_ram_0_m0_translator_avalon_universal_master_0_writedata),                                                                                                                                                                                                          //                          .writedata
		.uav_lock               (read_ram_0_m0_translator_avalon_universal_master_0_lock),                                                                                                                                                                                                               //                          .lock
		.uav_debugaccess        (read_ram_0_m0_translator_avalon_universal_master_0_debugaccess),                                                                                                                                                                                                        //                          .debugaccess
		.av_address             (read_ram_0_m0_address),                                                                                                                                                                                                                                                 //      avalon_anti_master_0.address
		.av_waitrequest         (read_ram_0_m0_waitrequest),                                                                                                                                                                                                                                             //                          .waitrequest
		.av_read                (read_ram_0_m0_read),                                                                                                                                                                                                                                                    //                          .read
		.av_readdata            (read_ram_0_m0_readdata),                                                                                                                                                                                                                                                //                          .readdata
		.av_readdatavalid       (read_ram_0_m0_readdatavalid),                                                                                                                                                                                                                                           //                          .readdatavalid
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                    //       clk.clk
		.reset                 (read_ram_0_reset_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.av_address            (read_ram_0_m0_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (read_ram_0_m0_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (read_ram_0_m0_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (read_ram_0_m0_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (read_ram_0_m0_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (read_ram_0_m0_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (read_ram_0_m0_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (read_ram_0_m0_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (read_ram_0_m0_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (read_ram_0_m0_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (read_ram_0_m0_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (read_ram_0_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (read_ram_0_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (read_ram_0_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (read_ram_0_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (read_ram_0_m0_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_1_router router (
		.sink_ready         (read_ram_0_m0_agent_cp_ready),                 //      sink.ready
		.sink_valid         (read_ram_0_m0_agent_cp_valid),                 //          .valid
		.sink_data          (read_ram_0_m0_agent_cp_data),                  //          .data
		.sink_startofpacket (read_ram_0_m0_agent_cp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (read_ram_0_m0_agent_cp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (read_ram_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
