...
module soc_system_mm_interconnect_0 (
		...
		output wire [5:0]  mm_bridge_0_s0_address,                                           //                                             mm_bridge_0_s0.address
	...
	wire  [122:0] mm_bridge_0_s0_agent_rp_data;                       // mm_bridge_0_s0_agent:rp_data -> router_002:sink_data
	...
	wire          router_002_src_valid;                               // router_002:src_valid -> mm_bridge_0_s0_rsp_width_adapter:in_valid
	wire  [122:0] router_002_src_data;                                // router_002:src_data -> mm_bridge_0_s0_rsp_width_adapter:in_data
	wire          router_002_src_ready;                               // mm_bridge_0_s0_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                             // router_002:src_channel -> mm_bridge_0_s0_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                       // router_002:src_startofpacket -> mm_bridge_0_s0_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                         // router_002:src_endofpacket -> mm_bridge_0_s0_rsp_width_adapter:in_endofpacket
	wire          mm_bridge_0_s0_rsp_width_adapter_src_valid;         // mm_bridge_0_s0_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [158:0] mm_bridge_0_s0_rsp_width_adapter_src_data;          // mm_bridge_0_s0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          mm_bridge_0_s0_rsp_width_adapter_src_ready;         // rsp_demux:sink_ready -> mm_bridge_0_s0_rsp_width_adapter:out_ready
	wire    [1:0] mm_bridge_0_s0_rsp_width_adapter_src_channel;       // mm_bridge_0_s0_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          mm_bridge_0_s0_rsp_width_adapter_src_startofpacket; // mm_bridge_0_s0_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          mm_bridge_0_s0_rsp_width_adapter_src_endofpacket;   // mm_bridge_0_s0_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                  // cmd_mux:src_valid -> mm_bridge_0_s0_cmd_width_adapter:in_valid
	wire  [158:0] cmd_mux_src_data;                                   // cmd_mux:src_data -> mm_bridge_0_s0_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                  // mm_bridge_0_s0_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                // cmd_mux:src_channel -> mm_bridge_0_s0_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                          // cmd_mux:src_startofpacket -> mm_bridge_0_s0_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                            // cmd_mux:src_endofpacket -> mm_bridge_0_s0_cmd_width_adapter:in_endofpacket
	wire          mm_bridge_0_s0_cmd_width_adapter_src_valid;         // mm_bridge_0_s0_cmd_width_adapter:out_valid -> mm_bridge_0_s0_burst_adapter:sink0_valid
	wire  [122:0] mm_bridge_0_s0_cmd_width_adapter_src_data;          // mm_bridge_0_s0_cmd_width_adapter:out_data -> mm_bridge_0_s0_burst_adapter:sink0_data
	wire          mm_bridge_0_s0_cmd_width_adapter_src_ready;         // mm_bridge_0_s0_burst_adapter:sink0_ready -> mm_bridge_0_s0_cmd_width_adapter:out_ready
	wire    [1:0] mm_bridge_0_s0_cmd_width_adapter_src_channel;       // mm_bridge_0_s0_cmd_width_adapter:out_channel -> mm_bridge_0_s0_burst_adapter:sink0_channel
	wire          mm_bridge_0_s0_cmd_width_adapter_src_startofpacket; // mm_bridge_0_s0_cmd_width_adapter:out_startofpacket -> mm_bridge_0_s0_burst_adapter:sink0_startofpacket
	wire          mm_bridge_0_s0_cmd_width_adapter_src_endofpacket;   // mm_bridge_0_s0_cmd_width_adapter:out_endofpacket -> mm_bridge_0_s0_burst_adapter:sink0_endofpacket
	...
	altera_merlin_burst_adapter #(
		...
		.sink0_valid           (mm_bridge_0_s0_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (mm_bridge_0_s0_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (mm_bridge_0_s0_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (mm_bridge_0_s0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (mm_bridge_0_s0_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (mm_bridge_0_s0_cmd_width_adapter_src_ready),         //          .ready
	...
	soc_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.sink_ready         (mm_bridge_0_s0_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (mm_bridge_0_s0_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (mm_bridge_0_s0_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (mm_bridge_0_s0_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (mm_bridge_0_s0_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (mm_bridge_0_s0_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) mm_bridge_0_s0_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                      //       clk.clk
		.reset                (mm_bridge_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		...
		.out_endofpacket      (mm_bridge_0_s0_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (mm_bridge_0_s0_rsp_width_adapter_src_data),          //          .data
		.out_channel          (mm_bridge_0_s0_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (mm_bridge_0_s0_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (mm_bridge_0_s0_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (mm_bridge_0_s0_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) mm_bridge_0_s0_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                      //       clk.clk
		.reset                (mm_bridge_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		...
		.out_endofpacket      (mm_bridge_0_s0_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (mm_bridge_0_s0_cmd_width_adapter_src_data),          //          .data
		.out_channel          (mm_bridge_0_s0_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (mm_bridge_0_s0_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (mm_bridge_0_s0_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (mm_bridge_0_s0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                              // (terminated)
	);
