...
#define BOOTENV \
	...
	\
	"distro_bootcmd=" \
    "echo --- HELLO DE U-BOOT ---; " \
    "echo --- CONFIG 500 Mo ---; " \
    "echo - mw 0xFFC25080 0x0 -; " \
    "mw 0xFFC25080 0x0 ; " \
    "echo - fatload mmc 0:1 0x2000000 soc_system.rbf -; " \
    "fatload mmc 0:1 0x2000000 soc_system.rbf ; " \
    "echo - fpga load 0 0x2000000 0x700000 -; " \
    "fpga load 0 0x2000000 0x700000 ;" \
    "echo - mw 0xFFC2505C 0xA -; " \
    "mw 0xFFC2505C 0xA ; " \
    "echo - mw 0xFFC25080 0xFFFF -; " \
